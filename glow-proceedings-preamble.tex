...
\newcommand\printcc{%
    \centering
    \begin{ccnotice}
    {}\makebox[0pt][r]{\copyright{} } \begin{refsection}\fullcite{Bárány2025glow}\end{refsection} \\
    %\begin{flushright}
    %This work is licensed under \href{https://creativecommons.org/licenses/by-sa/4.0/legalcode.en}{\texttt{CC BY-SA 4.0}} %
